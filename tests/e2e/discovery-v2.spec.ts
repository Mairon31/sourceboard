...
test("Discovery controls preserve applicable URL state and strip category for Users", async ({
  page,
}) => {
  seedCategoryBadgeFixture();
  await page.goto(
    "/search?q=E2E&kind=posts&filter=verified&category=anime&view=gallery",
  );
