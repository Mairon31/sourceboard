...
describe("i18n dictionaries", () => {
  it("keeps every locale complete and non-empty across message domains", () => {
    const englishKeys = Object.keys(allMessages.en).sort();
  ...
  it("interpolates plain text and pluralizes", () => {
    ...
    expect(translate("es", "store.unlockedFeedback", { name: "Aurora" })).toBe(
      "Aurora desbloqueado.",
    );
