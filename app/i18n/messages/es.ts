...
export const esMessages = {
  ...
  "footer.help": "Ayuda",
  "footer.acceptedSources": "Fuentes aceptadas",
  "footer.storePoints": "Tienda y puntos",
  "footer.policies": "Políticas",
  "footer.terms": "Términos",
  "footer.privacy": "Privacidad",
  "footer.communityGuidelines": "Normas de la comunidad",
  "footer.acceptableUse": "Uso aceptable",
  "footer.dataAttribution": "Datos y atribución",
  "footer.copyrightAttribution": "Derechos de autor y atribución",
  "footer.dataHandling": "Tratamiento de datos",
