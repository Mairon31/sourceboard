    ...
    <ProductShell rightRail={null}>
      <section className="product-not-found" aria-labelledby="product-not-found-title">
        <div className="product-not-found__visual" aria-hidden="true">
          <svg
            className="product-not-found__illustration"
            viewBox="0 0 160 160"
            focusable="false"
          >
            ...
            <circle className="product-not-found__spark product-not-found__spark--one" cx="119" cy="48" r="4" />
            <circle className="product-not-found__spark product-not-found__spark--two" cx="43" cy="116" r="3" />
          </svg>
        </div>
        <div className="product-not-found__copy">
          ...
          <p>The page you&apos;re looking for may have moved, changed, or no longer be available.</p>
        </div>
