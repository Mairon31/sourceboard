...
function defaultDefinition(preset: AvatarFramePreset): AvatarFrameDefinition {
  ...
  return {
    parts: parts.map((geometry, index) => ({
      id: `${preset}-${geometry.layer}-${index}`,
      geometry,
    })),
  };
}
