...
export default [
  index("routes/official-alias.tsx"),
  ...
  route("category", "routes/official-alias.tsx", { id: "category-alias" }),
  route("category/:categorySlug", "routes/official-alias.tsx", { id: "category-detail-alias" }),
  ...
  route("profile/:username", "routes/profile-legacy.tsx", { id: "legacy-profile" }),
  route("friends", "routes/friends.tsx"),
  route("notifications", "routes/notifications.tsx"),
  route("store", "routes/official-alias.tsx", { id: "store-alias" }),
  route("store/create", "routes/store-create.tsx"),
  route("settings", "routes/settings.tsx"),
  route("docs", "routes/official-alias.tsx", { id: "docs-alias" }),
  route("docs/:slug", "routes/official-alias.tsx", { id: "docs-article-alias" }),
  route("legal", "routes/official-alias.tsx", { id: "legal-alias" }),
