...
export default function NotificationsRoute() {
  ...
  return (
    <ProductShell>
      ...
      />
      <PresentationNotice>Realtime delivery arrives later; this page is rendered from typed fixtures.</PresentationNotice>
        ...
        {notifications.map((notification) => (
          ...
          >
            <div className="product-list-row__identity">
              <Avatar name={notification.actor?.displayName ?? "SourceBoard"} src={notification.actor?.avatarUrl} />
            ...
            <div className="product-chip-row">
              {!notification.isRead ? <span className="product-notification__unread">Unread</span> : <span>Read</span>}
