  ...
  return (
    <AdminShell>
      ...
      <div className="admin-metric-grid">
        ...
        <Card className="admin-metric">
          <Badge tone="success">Source review</Badge>
          <strong>1</strong>
          <span>Verified fixture today</span>
        </Card>
        <Card className="admin-metric">
          <Badge>Audit</Badge>
          <strong>0</strong>
          <span>Persistent writes in Phase 0B</span>
        </Card>
      </div>

      <PresentationNotice>
        Admin metrics and actions are fixture-backed presentation states. No privileged write path
        ...
        <div className="admin-table">
          ...
          <div className="admin-table__row">
            <div className="admin-table__copy">
              <strong>Original editorial photo found and verified</strong>
